    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* About */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">Школа №225</h3>
            <p className="text-sm mb-4">
              Сучасний заклад освіти, що забезпечує якісну освіту та всебічний розвиток учнів відповідно до вимог законодавства України.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">Швидкі посилання</h3>
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/anti-bullying" className="hover:text-white transition-colors">
                  Запобігання булінгу
                </Link>
              </li>
            </ul>
