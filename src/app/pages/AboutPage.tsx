                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-gray-700">
                      Комунальний заклад «Загальноосвітня школа І-ІІІ ступенів №225 Київської міської ради»
                    </p>
                  </div>
                  <div>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-700 leading-relaxed">
                  Школа №225 розпочала свою діяльність у 1975 році як середня загальноосвітня школа. 
